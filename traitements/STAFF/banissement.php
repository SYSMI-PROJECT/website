...
if(isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    try {
        // Préparer la requête pour mettre à jour la colonne "banni" de l'utilisateur
        $stmt = $conn->prepare("UPDATE utilisateur SET banni = 1 WHERE id = :id");
        ...
        // Redirection vers la page précédente après bannissement
