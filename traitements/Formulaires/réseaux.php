...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['social']) && !empty($_POST['link'])) {
        ...
        switch ($social) {
            case 'YouTube':
                ...
                if (!preg_match('~^(?:https?://)?(?:www\.)?youtube\.com/.+$~', $link)) {
                    header("Location: ../../Import/Error/social_incorrect.php?message=Le+format+du+lien+YouTube+est+invalide.");
                    exit;
                }
                break;
            case 'TikTok':
                ...
                if (!preg_match('~^(?:https?://)?(?:www\.)?tiktok\.com/.+$~', $link)) {
                    header("Location: ../../Import/Error/social_incorrect.php?message=Le+format+du+lien+TikTok+est+invalide.");
                    exit;
                }
                break;
            case 'Instagram':
                ...
                if (!preg_match('~^(?:https?://)?(?:www\.)?instagram\.com/.+$~', $link)) {
                    header("Location: ../../Import/Error/social_incorrect.php?message=Le+format+du+lien+Instagram+est+invalide.");
                    exit;
                }
                break;
            case 'Snapchat':
                ...
                if (!preg_match('~^(?:https?://)?(?:www\.)?snapchat\.com/add/.+$~', $link)) {
                    header("Location: ../../Import/Error/social_incorrect.php?message=Le+format+du+lien+Snapchat+est+invalide.");
                    exit;
                }
                break;
            case 'Discord':
                ...
                if (!preg_match('~^(?:https?://)?(?:www\.)?(?:discord\.gg/|discord\.com/invite/).+$~', $link)) {
                    header("Location: ../../Import/Error/social_incorrect.php?message=Le+format+du+lien+Discord+est+invalide.");
                    exit;
                }
                break;
            case 'Twitch':
                ...
                if (!preg_match('~^(?:https?://)?(?:www\.)?twitch\.tv/.+$~', $link)) {
                    header("Location: ../../Import/Error/social_incorrect.php?message=Le+format+du+lien+Twitch+est+invalide.");
                    exit;
                }
                break;
        ...
        if ($user_id !== null) {
            ...
            header("Location: ../../Import/Error/Succes.php");
        } else {
